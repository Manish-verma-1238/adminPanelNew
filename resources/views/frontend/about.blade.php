    ...
    <div class="center_search_about">
        <div class="container-fluid hero-header-about mb-5">
            <div class="container text-center">
                <h1 class="display-4 mb-3 animated">About Us</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
                        <li class="breadcrumb-item"><a class="text-reset" href="{{route('main')}}"><strong>Home</strong></a></li>
                        <li class="breadcrumb-item" style="color: var(--main-color);" aria-current="page"><b>About
                                Us</b>
                        </li>
                    </ol>
                </nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8 col-12">
                <div class="about_txt">
                    <h2>Welcome to ZipZap Taxi</h2>
                    <h5>Explore the Vibrant Tapestry of Indian Streets with ZipZap Taxi.</h5><br>
                    <p class="wow" data-wow-duration="1s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInDown;">Since its inception in 2020, ZipZap Taxi has been dedicated to providing unparalleled taxi and cab services across India, ensuring travelers experience smooth and secure rides while exploring the diverse landscapes of this beautiful country. Over the years, we have delighted countless passengers by safely transporting them to their destinations, spreading smiles along the way. With branches established in numerous cities across India, we aim to extend our services to travelers nationwide.</p><br>
                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-12 ">
                <div class="about_img pt-5 mt-5">
                    <img src="{{asset('assets/frontend/uploads/home-about-img.png')}}" loading="lazy">
                </div>
            </div>
            <div class="about_txt">
                <h5>Diverse Fleet Selection</h5><br>
                <p>At ZipZap Taxi, we understand that every traveler has unique preferences. That's why we offer a wide variety of vehicles to choose from, ensuring you find the perfect taxi to suit your needs and preferences.</p>
                <h5>Air-conditioned and Sanitized Vehicles</h5><br>
                <p>The safety and comfort of our passengers are our top priorities. All our vehicles are air-conditioned, non-smoking, and meticulously sanitized after each use, in compliance with the highest safety standards. We prioritize your well-being and strive to provide a clean and hygienic environment throughout your journey.</p>
                <h5>Certified and Courteous Drivers</h5><br>
                <p>Rest assured, you're in safe hands with ZipZap Taxi. Our team comprises certified, well-mannered, and experienced drivers who have undergone thorough background checks. Your safety and satisfaction are our utmost concerns, and our drivers are committed to delivering a pleasant and hassle-free journey.</p>
                <h5>Airport Transfer Services</h5><br>
                <p>Missing a flight due to transportation issues can be a nightmare. With ZipZap Taxi's specialized Airport Transfer services, you can bid farewell to such worries. Our prompt and reliable airport taxi services ensure you reach the airport on time, allowing you to catch your flight without any hassle or delay.</p>
                <h5>Railway Transfer Services</h5><br>
                <p>Arriving at or departing from a railway station? ZipZap Taxi offers convenient railway transfer services to ensure a seamless travel experience. Our reliable and punctual drivers will ensure you reach your destination on time, whether it's boarding a train or reaching your hotel after a journey.</p>
                <h5>Hotel Transfer Services</h5><br>
                <p>Planning to check into a hotel? Let ZipZap Taxi take care of your transportation needs. Our hotel transfer services guarantee a hassle-free journey from the moment you arrive at your destination. Sit back, relax, and enjoy a comfortable ride to your accommodation, courtesy of ZipZap Taxi.</p>
                <h5>24/7 Availability</h5><br>
                <p>Emergencies can arise at any time, and we understand the importance of having access to reliable transportation round the clock. Whether you need to catch an early morning flight, reach a railway station, or check into a hotel, ZipZap Taxi is at your service 24 hours a day, 7 days a week. Say goodbye to transportation woes and rely on us for seamless and convenient taxi services whenever you need them.</p><br>
                <p>Experience the convenience, comfort, and reliability of ZipZap Taxi on your next trip across India. Book your ride today and embark on a memorable journey with us.</p>
            </div>
        </div>
    </div>
</section>
