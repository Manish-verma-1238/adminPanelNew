...
<head>
    ...
    <title>zipZap</title>
    <meta charset="UTF-8" />
    <link rel="icon" href="./uploads/logo nav.png" type="image/x-icon" />
    <link rel="preload" href="./assets/maxcdn.bootstrapcdn.com/bootstrap/bootstrap.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <link rel="preload" href="./assets/maxcdn.bootstrapcdn.com/font-awesome/font-awesome.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <!-- <noscript>
                <link rel="stylesheet" href="./assets/maxcdn.bootstrapcdn.com/font-awesome/font-awesome.min.css"
                        style="font-display: swap;">
        </noscript> -->
    <!--<link rel="preload" href="https://zipzap.in/assets/frontuser/css/owl.carousel.min2.css" as="style" onload="this.onload=null;this.rel='stylesheet'">-->
    <!--<noscript><link rel="stylesheet" href="https://zipzap.in/assets/frontuser/css/owl.carousel.min2.css"></noscript>-->
    <link rel="stylesheet" href="./assets/frontuser/css/owl.carousel.min2.css" as="style">
    <!--<link rel="stylesheet" href="https://ux.duplexsoftwares.com/Bizstart/css/owl.theme.default.min.css" as="style"> -->
    <link rel="stylesheet" href="./assets/cdnjs.cloudflare.com/owl.theme.default.min.css" as="style">
    <link rel="preload" href="assets/frontuser/css/animate.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <!-- <noscript>
                <link rel="stylesheet" href="assets/frontuser/css/animate.css">
        </noscript> -->
    <link rel="preload" href="assets/frontuser/css/style.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <!-- <noscript>
                <link rel="stylesheet" href="assets/frontuser/css/style.css">
        </noscript> -->

    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" style="font-display: swap;">
    <link rel="preload" href="assets/frontuser/css/date-picker.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <!-- <noscript>
                <link rel="stylesheet" href="assets/frontuser/css/date-picker.css">
        </noscript> -->
    <link rel="preload" href="assets/frontuser/css/jquery.datetimepicker.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="assets/frontuser/css/jquery.datetimepicker.min.css">
    </noscript>
    <link href="assets/frontuser/css/jquery.datetimepicker.min.css" rel="stylesheet" type="text/css" media="all">


</head>

<body>
    <script src="./assets/frontuser/js/jquery.min.js"></script>
    <script src="./assets/code.jquery.com/jquery-ui.min.js" integrity="sha256-eGE6blurk5sHj+rmkfsGYeKyZx3M4bG+ZlFyA7Kns7E=" crossorigin="anonymous"></script>
        ...
        <nav class="navbar navbar-expand-md header_bg sidebarNavigation" data-sidebarClass="navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand logo-img" href="index.html">
                    <img src="uploads/logo nav.png" height="90px">
                </a>

                <a target="_blank" href="https:#" class="d-block d-sm-none header-social-icon"> <i class="fa fa-facebook"></i></a>


                <a target="_blank" href="#" class="d-block d-sm-none header-social-icon"> <i class="fa fa-twitter"></i></a>


                <a target="_blank" href="#" class="d-block d-sm-none header-social-icon"> <i class="fa fa-linkedin"></i></a>


                <button class="navbar-toggler leftNavbarToggler bg-size" type="button" style="background-image: url('assets/frontuser/images/icons/menu.png');" data-toggle="collapse" data-target="#menu_bar" aria-controls="menu_bar" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="row">
                    <div class="col-md-7 col-lg-7 col-12">
                        <div class="center_txt">
                            ...
                            <h1 class="d-sm-block d-none"><span class="text-dark ">Your Taxi
                                    Booking</span> <br>App On
                                Demand</h1>
                                    ...
                                    <div class="buzz_header">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item w-50 text-center">
                                                <a class="nav-link active br-l" id="outstation-tab" data-toggle="tab" href="#outstation" role="tab" aria-controls="outstation-tab" aria-selected="true">Oneway
                                                    /<br>
                                                    Roundway</a>
                                            </li>
                                            <li class="nav-item w-50 text-center" onclick="showlocal();">
                                                <a class="nav-link br-r" id="local-tab" onclick="tabcheck();return false;" data-toggle="tab" href="#local" role="tab" aria-controls="local" aria-selected="false">Local/Airport/<br>Railway
                                                    Station
                                                </a>
                                            </li>
                                        </ul>
        ...
        <div class="container">
            ...
            <div class="gtco-testimonials">
                ...
                <div class="owl-carousel owl-carousel1 owl-theme">
                    <div>
                        <div class="card text-center"><img class="card-img-top" src="uploads/testi.jpeg" alt="">
                            <div class="card-body">
                                <h5>Ronne Galle <br />
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6yBdRAaXL0efrkiiYtWJ0KRu8Gf_Iw8A&amp;libraries=places&amp;callback=initAutocomplete"></script>



    <script src="./assets/cdnjs.cloudflare.com/popper.min.js"></script>
    <script src="./assets/maxcdn.bootstrapcdn.com/bootstrap/bootstrap.min.js"></script>
    <script src="assets/frontuser/js/owl.carousel.min2.js"></script>
    <script src="assets/frontuser/js/wow.js"></script>



    <script src="assets/frontuser/js/jquery.datetimepicker.full.js"></script>

    <script async defer src="assets/frontuser/js/validation.js"></script>
